...
| [`lecture/`](lecture/) | 初学者向け講義資料（このアプリを一から作る教材、全21章＋README） | 2026-06-11 に固定シフト/アナウンス章を追加・網羅監査済み |
| [`GIT_GUIDE.md`](GIT_GUIDE.md) | Git の使い方ガイド（commit/push/pull・**ブランチ**・**マージ**・コンフリクト） | 随時更新 |
